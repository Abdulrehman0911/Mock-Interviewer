    ...
    <main className="min-h-screen grid place-items-center bg-background text-foreground px-4 py-12">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2.5 mb-8">
          <span className="grid place-items-center h-10 w-10 rounded-xl bg-primary text-primary-foreground shadow-elegant">
            <Sparkles className="h-5 w-5" />
          </span>
          <span className="font-bold tracking-tight text-xl">MockMate</span>
        </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full h-11 mt-2 shine" disabled={busy}>
                  {busy ? (
