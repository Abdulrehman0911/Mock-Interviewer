...
function InterviewPage() {
  ...
  const [processingMsg, setProcessingMsg] = useState("Processing your answer…");
  ...
  const stopRecordingAndProcess = useCallback(async () => {
    ...
    const msgs = [
      "Analyzing your eye contact…",
      "Evaluating your speaking pace…",
              ...
              <div className="flex flex-wrap gap-3">
                ...
                {stage === "processing" && (
                  <div className="flex items-center gap-3 py-2">
                    ...
                    <span className="text-sm text-muted-foreground">{processingMsg}</span>
                  </div>
                )}
              </div>
